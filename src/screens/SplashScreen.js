  ...
  return (
    <>
      ...
      <View style={styles.container}>
            ...
            <View style={styles.innerRing}>
              <View style={styles.centerIcon}>
                ...
                <View style={styles.building}>
                  ...
                  <View style={[styles.window, styles.window1]} />
                  <View style={[styles.window, styles.window2]} />
                  <View style={[styles.window, styles.window3]} />
                  <View style={[styles.window, styles.window4]} />
                </View>
              </View>
            </View>
          </View>
        ...
        >
          <Text style={styles.appTitle}>SchoolERP</Text>
          <Text style={styles.tagline}>Complete School Management</Text>
...
const styles = StyleSheet.create({
  container: {
    ...
    alignItems: 'center',
    backgroundColor: '#667eea', // Deep blue
    position: 'relative',
  },
  backgroundPattern: {
    position: 'absolute',
